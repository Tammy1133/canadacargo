...
export const OtherProvince = () => {
  ...
  const [boxNumber, setBoxNumber] = useState("jffhf");
  ...
  const handleFormSubmit = async (e) => {
    try {
      ...
      const result = await Swal.fire({
        title: "Are you sure?",
        text: "Do you want to proceed with saving the delivery options?",
        icon: "warning",
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/createArrivalResponse`,
        {
          trans_id: transId,
          boxnumber: boxNumber,
          fullname: fullName,
      ...
      Swal.fire({
        icon: "success",
        title: "Successful!",
        text: "Delivery options saved successfully.",
      });
      ...
      Swal.fire({
        icon: "error",
        title: "Error Creating Arrival Response",
  ...
  const checkTransactionExists = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/checkTransactionExists`,
        {
          trans_id: transId,
        },
        {
              ...
              {activeTab === "actions" &&
                (!errorMessage ? (
                  <div className="mt-6">
                    ...
                    <div>
                      <label className="block my-3 font-medium">Address:</label>
                      <input
                        type="text"
                        value={address}
                    ...
                    <div>
                      <label className="block my-3 font-medium">City:</label>
                      <input
                        type="text"
                        value={city}
                  ...
                  <div>
                    <h3 className="mt-5">
                      Delivery information has been submitted.
                    </h3>
                  </div>
                ))}
