...
export const CourierTable = ({ alltaxrates, deleteCourier }) => {
      ...
      <div className="rounded-lg border border-slate-50 bg-white p-6 shadow-lg">
        ...
        <div className="overflow-x-auto">
          <table
            id="example"
            border={2}
            className="min-w-full border mytable border-slate-50 divide-y divide-slate-300 pt-5"
          >
            ...
            <tbody className="bg-white divide-y divide-slate-300 "></tbody>
          </table>
        </div>
      </div>
    </>
