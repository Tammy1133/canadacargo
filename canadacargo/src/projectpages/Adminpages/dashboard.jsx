  ...
  return (
    userToken && (
      <>
          ...
          {statsData.map((d, k) => {
            ...
            return (
              <div className="stats shadow" key={k}>
                <div className="stat">
                  <div
                    className={`stat-figure dark:text-slate-300 text-sm !text-black`}
                  >
                    {icon}
                  </div>
        ...
        <div className="grid lg:grid-cols-2 mt-4 grid-cols-1 gap-6 items-start">
          <div className="">
            <MyDoughnutChart
