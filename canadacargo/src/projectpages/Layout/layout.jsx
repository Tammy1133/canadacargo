...
import ArrivalResponse from "../UserPages/arrivalResponse";
import PaymentResponse from "../UserPages/paymentResponse";
...
function Layout() {
  ...
  const { modulesLoading, userModules } = useContext(AppContext);
  ...
  const moduleRouteMap = {
    "user creation": "/newuser",
    "user management": "/newuseredit",
    "view all shipments": "/allshipments",
    "arrival response": "/arrivalresponse",
    "payment notification": "/paymentresponse",
    "editing shipments": "/allshipmentedit",
    "new shipment": "/newshipment",
    "pending weighment": "/pendingweighments",
    "pending payments/ complete payments": [
      "/pendingpayments",
      "/completedpayments",
    ],
    "generate qr": "/generatecode",
    "view out of office list": "/outofoffice",
    "mark shipment in transit": "/markintransit",
    "view all shipments in transit": "/intransit",
    "view arrived shipments": "/arrivals",
    "scan qr": "/scanning",
    configurations: "/Configurations",
    "view revenue report": "/revenuereport",
    "view shipment report": "/shipmentreport",
  };
        ...
        routes.filter((route) => {
          return (
            ...
            userModules.some((module) => {
              const paths = moduleRouteMap[module?.toLowerCase()];
          ...
          <div className="navbar sticky top-0 bg-base-100  z-10 shadow-md ">
            ...
            <div className="flex-none ">
              ...
              >
                ...
                <span className="ml-2 uppercase text-[10px] sm:text-[14px]">
                  {userDetails?.email}
                </span>
                <svg
                  className="w-2 h-2 sm:w-4 sm:h-4 ml-1"
